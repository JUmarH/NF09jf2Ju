    ...
    content: `
      <div class="slide-layout-standard">
        <ul style="font-size:1.5rem; line-height:2;">
          ...
          <li>Akses menu: <code style="background:#334155; padding:0.2rem 0.5rem; border-radius:4px;">Administrasi -> Perpustakaan -> Bebas Pustaka</code></li>
    ...
    content: `
      <div class="slide-layout-standard" style="display:flex; gap:2rem;">
        <div style="flex:1;">
          ...
          <p>Pisahkan file PDF menjadi: 1. Fulltext utuh. 2. Halaman Pengesahan (bertandatangan). 3. Bab Pendahuluan. 4. Bab Penutup. 5. Daftar Pustaka.</p>
        </div>
        <div style="flex:1;">
          <h3 style="color:#fb923c; margin-bottom:1rem;">Metadata (PUEBI)</h3>
